# Step 02: Add README Instructions
...
- [ ] README includes: installation instructions (`npm install`)
- [ ] README includes: how to run the server (`npm start`)
- [ ] README includes: how to run tests (`npm test`)
- [ ] README includes: how to run build (`npm run build`)
- [ ] README includes: link or reference to `docs/SERVER.md` for detailed documentation
- [ ] README includes: endpoints table (GET /, GET /health)
- [ ] README includes: optional quick-start mermaid diagram
